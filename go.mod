module github.com/xtrasolver/provider-azuredevops
...
require (
	...
	github.com/upbound/upjet-provider-template v0.0.0-20230419115259-f965062822c3
...
require (
	...
	github.com/go-openapi/jsonpointer v0.19.5 // indirect; indirect;
